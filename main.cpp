...
void check()
{
    if(m_word=="hi"||m_word=="hey"||m_word=="hello"||m_word=="hlo")
         {
            x.typing("Hi SHUBHAM, how can I help you..");
         }
    ...
    else if (m_word=="play")
    {
      ...
      {
          x.speak("Sorry SHUBHAM ,you does not enter song name");
         // tutorial("play");
      }
      else
        {
          ...
          {
            x.speak("Good bye, SHUBHAM");
            Sleep(600);
            cout<<"\n\n\n\n\n\n\t\t\t\t\t";
            x.typing("Created By : SHUBHAM GHUGE");
            Sleep(1500);
            exit(1);
          }
      ...
      else if(m_word=="what"||m_word=="who"||m_word=="how"||m_word=="when"||m_word=="where"||m_word=="why")
      {
          ...
          {
            x.typing("My name is ERA.");
          }
          else if (input=="who are you"||input=="who created you"||input=="who made you")
          {
              x.typing("I am ERA, a personal assistant");
              Sleep(300);
              line();
              x.typing("SHUBHAM GHUGE has made me.");
              Sleep(300);
              line();
              x.typing("I was created on 1 MARCH ,2022");
              Sleep(300);
              line();
       ...
       {
         x.speak("Sorry SHUBHAM, unknown comaand...");
         cnt++;
         if(cnt>=3)
         {  Sleep(600);
            x.speak("I think ");
...
void player(string item)
{
  ...
  file.open("C:\\Users\\SHUBHAM\\Music\\download",ios::app);
...
//---------------- online search and also download songs----------------
...
void srch(string query,string extra)
{
          for(int i=0;query[i]!='\0';i++)
            ...
            if(extra == "youtube")
            {
                url= "start https://www.youtube.com//search?q=";
                url+=query;
            ...
            else if(extra == "movie")
            {
                ...
                url= "start https://www.google.com/search?q=";
                url+=query;
                url+="+https://www.google.com/search?q=hindi+movie&sxsrf=ALiCzsZougrnNKJi7CbGUeuJxdEt3x5UzA%3A1653470700065&ei=7PWNYoniA_-bseMP-P6-iAc&ved=0ahUKEwiJiOWtqvr3AhX_TWwGHXi_D3EQ4dUDCA0&uact=5&oq=hindi+movie&gs_lcp=&sclient=gws-wiz";
                system(string(url).c_str());
            }
            else
            {
...
system("cls");
system("color f");
x.speak(" Welcome to the Hacking Lab");
...
Sleep(1000);
system("color c");
cout << setfill(' ') << setw(50) <<" SHUBHAM Hacking Lab  \n";
Sleep(1000);
line();
...
cout << setfill(' ') << setw(75) <<"   14.exit/quit/q            \n";
cout << setfill(' ') << setw(75) <<"   15.shutdown/restart       \n";
cout << setfill(' ') << setw(75) <<"   16.install                \n";
system("pause");
}
